...
%\centering
%\subfloat[Gambar 1]{
%\includegraphics[scale=0.3]{graphs/cdn.eps}
%\label{fig:4-0}}
%\quad
%\subfloat[Gambar 2]{
%\includegraphics[scale=0.3]{graphs/cdnp2p-1.eps}
%\label{fig:4-1}}
%\quad
%\subfloat[Gambar 3]{
%\includegraphics[scale=0.3]{graphs/cdnp2p-2.eps}
%\label{fig:fig4-2}}
%\quad
%\subfloat[Gambar 4]{
%\includegraphics[scale=0.3]{graphs/cdnp2p-3.eps}
%\label{fig:fig4-3}}
%\caption{Main Figure}
