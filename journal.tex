...
Compare to pure CDN architecture peer-assisted, peer assisted online storage total system energy saving less than $1\%$ while comparing CDN service only can save energy consumption up to $23\%$.
