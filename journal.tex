...
Since server hold important role in this system, we present mathematical model and server bandwidth allocation strategies as base for energy calculation later in Sec.\ref{subsec:onlinestorage}.
