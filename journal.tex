...
Since server hold important role in this system, we present simple mathematical model and server bandwidth allocation strategies \cite{4024139,Sun:2009:POS:1542245.1542249} as base for energy calculation later in Sec.\ref{subsec:onlinestorage}.
...
First we introduce some mathematical notation:\\  
...
The parameters used in this numerical simulation were adapted from \cite{Nedevschi:2008:HDC:1855610.1855618} and \cite{valancius2009greening}. 
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{graphs/topology.eps}
\end{center}
...
\subsection{Online Storage}\label{subsec:onlinestorage}
