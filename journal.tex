...
\begin{table}[tb]
\caption{Notation of Key Parameters and Its Value. Capacity in Gbps and Power Consumption in kW.}
\label{tab:parameters}
\hbox to\hsize{\hfil
\begin{tabular}{l|l|l|l}\hline\hline
Location & Equipment & Capacity &  Power\\\hline
Access & DSLAM & $C_{dsl}^{up}=0.005$ & $P_{dsl}=0.0035$ \\
& & $C_{dsl}^{down}=0.025$ & per subscriber \\
Metro & Switch & $C_{es}=320$ & $P_{es}=3.55$ \\
& BRAS & $C_g=8$ & $P_g=1.1$ \\
& Edge Router & $C_{pe}=140$ & $P_{ce}=2.7$ \\
Core & Core Router & $C_c=640$ & $P_c=9.15$ \\
& WDM & $C_{wdm}=3200$ & $P_{wdm}=22.6$ \\
Data & L3 Lan Switch & $C_es=320$ & $P_{es}=3.55$ \\
Center & Edge router & $C_{pe}=140$ & $P_{pe}=2.7$ \\
& Server & $C_{sr}=0.8$ & $P_{sr}=0.35$ \\
& Storage & $S_{sd}=604800$ & $P_{sd}=4.9$ \\ 
Home & Server & $C_{srb}^{up}=0.005$ & $P_{stb}=0.03$ \\
Set Top & Server & $C_{srb}^{down}=0.025$ & \\
Box & Storage & $S_{sdb}=2560$ & \\
- & $D$ & Number of download & \\
& & per hour & \\
- & $H$ & Number of hops &  \\
- & $n$ & Number of replicas & \\
- & $B_k$ & Size of the $k$-th most &  \\
& & popular content & \\
- & $R_k$ & No.of request of the  & \\
& & $k$-th most popular content & \\\hline
\end{tabular}\hfil}
\end{table}
