/usr/local/texlive/2013/bin/x86_64-darwin/bibtex journal
/usr/local/texlive/2013/bin/x86_64-darwin/latex journal 
/usr/local/texlive/2013/bin/x86_64-darwin/bibtex journal
/usr/local/texlive/2013/bin/x86_64-darwin/latex journal 
/usr/local/texlive/2013/bin/x86_64-darwin/dvips -t a4 -G0 -o journal.ps journal.dvi
